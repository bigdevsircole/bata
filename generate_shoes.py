...
shoes = [
    {"name": "The Oduduwa Brogue", "desc": "Intricate perforations inspired by royal lineage", "img": "https://images.unsplash.com/photo-1533867617858-e7b97e060509?w=600&q=80", "price": 950000},
    ...
    {"name": "The Aare Wholecut", "desc": "Seamless perfection from a single piece of leather", "img": "https://images.unsplash.com/photo-1620809310862-2ee7b2c589bd?w=600&q=80", "price": 1250000},
    {"name": "The Yemoja Moccasin", "desc": "Fluid, flexible comfort inspired by the waves", "img": "https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?w=600&q=80", "price": 760000},
    ...
    {"name": "The Ogbomoso Sneaker", "desc": "Luxury meets casual in this hand-stitched runner", "img": "https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77?w=600&q=80", "price": 550000},
    ...
    {"name": "The Marina Split-Toe", "desc": "Nautical nods with meticulous hand-sewn aprons", "img": "https://images.unsplash.com/photo-1608231387042-66d1773070a5?w=600&q=80", "price": 980000},
    {"name": "The Ibadan Wingtip", "desc": "Classic punch detailing on antiqued calf", "img": "https://images.unsplash.com/photo-1595341888016-a392ef81b7de?w=600&q=80", "price": 870000},
    {"name": "The Oyo Balmoral", "desc": "Sleek ankle boot combining suede and calf", "img": "https://images.unsplash.com/photo-1607522370275-f14206abe5d3?w=600&q=80", "price": 1100000},
    ...
    {"name": "The Heritage Monk", "desc": "Single brass buckle reflecting historical trade", "img": "https://images.unsplash.com/photo-1533867617858-e7b97e060509?w=600&q=80", "price": 870000},
...
# Provide unique delays for scroll reveal
html_output = "\n"

for i, shoe in enumerate(shoes):
    delay = (i % 3 + 1) * 0.1
    formatted_price = f"₦{shoe['price']:,}"
    
    html_output += f"""                <!-- Shoe Card {i+4} -->
...
with open('c:/Users/dell/Documents/CODINGS/jacob-feet/index.html', 'r', encoding='utf-8') as f:
    content = f.read()

target = "            </div>\n\n            <div class=\"mt-16 text-center\">"
replacement = html_output + target

new_content = content.replace(target, replacement)

with open('c:/Users/dell/Documents/CODINGS/jacob-feet/index.html', 'w', encoding='utf-8') as f:
    f.write(new_content)

print("Successfully injected 30 shoes into the catalogue!")
